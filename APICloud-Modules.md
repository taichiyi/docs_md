...
一个本地媒体资源扫描器，在 Android 平台上可扫描整个设备的资源，iOS 仅扫描相册内的资源。本模块仅支持对本地图片资源的浏览、读取，目前尚不支持编辑。

**UIAlbumBrowser 模块是 UIMediaScanner 模块的优化升级版。**

### 文档

[http://docs.apicloud.com/Client-API/UI-Layout/UIAlbumBrowser](http://docs.apicloud.com/Client-API/UI-Layout/UIAlbumBrowser)  
